<#   
========= Create-AzureRMSampleVM.ps1 ======================================= 
 Name: Create-AzureRMSampleVM 
 Purpose: Create Azure VM using Resource Group Template and Parameters file
          Uses New-AzureRmResourceGroupDeployment to create the VM
 ...
 Syntax/Execution: 
      ...
      ./Create-AzureRMSampleVM.ps1  
      ./Create-AzureRMSampleVM.ps1  -SubscriptionID "12345-6789..." -rgName "myResourceGroupName" -Location eastus
...
# We have collected variables from user now let's do the work...
$templateFile = "SampleVM.json"
$parameterFile = "SampleVMparameters.json"
